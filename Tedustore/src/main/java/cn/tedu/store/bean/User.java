...
public class User implements Serializable{
	...
	private static final long serialVersionUID = -8394721219174946084L;
	private Integer id;
	...
	public User(Integer id, String username, String password, String phone, String email, String image, Integer gender,
	...
	public void setEmail(String emoail) {
		this.email = emoail;
	}
	...
	public String toString() {
		return "User [id=" + id + ", username=" + username + ", password=" + password + ", phone=" + phone + ", email="
				+ email + ", image=" + image + ", gender=" + gender + ", createdUser=" + createdUser + ", createdTime="
