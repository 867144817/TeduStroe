...
public class Address implements Serializable{
	...
	private static final long serialVersionUID = -1101052789558976214L;
	private Integer id;
	private Integer uid;//用户id
	private String recvUsername;//收货人新名
	private String recvProvinceCode;//省编号
	private String recvCityCode;//市编号
	private String recvAreaCode;//区编号
	private String recvAddress;//详细地址
	private String recvDistrict;//地址详情
	private String recvPhone;//电话
	private String recvTel;//固话
	private String recvZip;//邮编
	private String recvTag;//地址名称
