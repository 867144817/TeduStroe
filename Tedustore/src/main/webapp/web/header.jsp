	...
	<header id="top" class="fixed_nav">
		...
		<div class="rt">
			<ul class="lf">
				...
				<li><a href="" title="我的收藏"><img class="care"
						src="../images/header/care.png" alt="" /></a><b>|</b></li>
				<li><a href="../web/orders.jsp" title="我的订单"><img class="order"
						src="../images/header/order.png" alt="" /></a><b>|</b></li>
				<li><a href="../cart/cart.do" title="我的购物车"><img class="shopcar"
						src="../images/header/shop_car.png" alt="" /></a><b>|</b></li>
				<li><a href="help.html">帮助</a><b>|</b></li>
				<li> 
						<c:choose>
							<c:when test="${user==null }">
							<a href="../user/showLogin.do">登陆</a>
							</c:when>
							<c:otherwise>
