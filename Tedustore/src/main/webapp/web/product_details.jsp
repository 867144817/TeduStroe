...
<!--细节导航-->
<div id="nav_detail">
    <h5>首页 > 学习用品 > 笔记本电脑 > ${goods.title }</h5>
</div>
<!--产品预览-->
<div id="shop_detail">
    <!-- 左侧-->
    <div id="preview" class="lf">
        <div id="mediumDiv">
            <img id="mImg" src="..${goods.image }" class="wb100"/>
        </div>
        <div id="icon_all">
            <ul id="icon_list">
    ...
    <div class="right_detail lf">
        ...
        <div class="shops">
            ...
            <a href="###" class="shop lf" data-gid="${goods.id }" id="add_cart"><img src="../images/product_detail/product_detail_img7.png" alt=""/>加入购物车</a>
            ...
            <c:forEach items="${goodList }" var="good">
            	 <div class="detail_1 lf">
                    <div class="detail_img1">
                        <img src="..${good.image }" class="" border="0">
                    </div>
                    <p>${good.title }</p>
                </div>
            </c:forEach>
    ...
    <div id="tab">
        <div class="tab lf">
            <div class="cat">
                ...
                <span><a href="lookforcartward.html">商品评价</a></span>
            </div>
        </div>
        <div class="cart rt">
...
<script type="text/javascript">
    ...
    function getPro(){
        ...
        console.log(buyAccount);cart
    }
    $("#add_cart").click(function (e) {
	
        var params = {
        		goodsId: $(this).data("gid"),
            //uid: ${user.id},
            num: $("#buy-num").val(),
			//商品id    temId:${item.id}
        };
