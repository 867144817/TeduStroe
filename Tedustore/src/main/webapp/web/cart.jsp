    ...
    <section id="section" >
        ...
        <div id="box" >
            <div id="content_box">
                ...
                <c:forEach items="${cartList }" var="cl" varStatus="cart">
							<div class="imfor">
								<div class="check">
									<div class="Each">
								...
								<div class="pudc">
									<div class="pudc_information" id="${cl.id }">
										<img src="..${cl.image }" class="lf w84" /> <input
								...
								<div class="pices">
									...
									<p class="pices_information">
										<b>￥</b><span>${cl.price }.00 <input type="hidden" name=""
											value=""></span>
									</p>
								</div>
								<div class="num">
									<span class="reduc">&nbsp;-&nbsp;</span><input type="text"
										value="${cl.num }"><span class="add">&nbsp;+&nbsp;</span>
								</div>
								<div class="totle">
									<span>￥</span> <span class="totle_information">${cl.price*cl.num }.00</span>
								</div>
								<div class="del">
									<!-- <div>
                        ...
                        -->
									<a href="javascript:;" class="del_d" data-id="${cl.id }">删除</a>
								</div>
							</div>
						</c:forEach>
